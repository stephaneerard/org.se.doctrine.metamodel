 ...
 * $Id$
 */
package doctrine.Class.Listeners.util;
...
public class ListenersAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ListenersSwitch<Adapter> modelSwitch =
		new ListenersSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link doctrine.Class.Listeners.Listeners <em>Listeners</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link doctrine.Class.Listeners.Listener <em>Listener</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
