 ...
 * <ul>
 *   <li>{@link doctrine.Class.Behaviors.impl.BehaviorsImpl#getBehaviors <em>Behaviors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BehaviorsImpl extends EObjectImpl implements Behaviors {
	/**
	...
	protected EClass eStaticClass() {
		return BehaviorsPackage.Literals.BEHAVIORS;
	}
	...
	public EList<Behavior> getBehaviors() {
		if (behaviors == null) {
			behaviors = new EObjectContainmentEList<Behavior>(Behavior.class, this, BehaviorsPackage.BEHAVIORS__BEHAVIORS);
		}
		return behaviors;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviorsPackage.BEHAVIORS__BEHAVIORS:
