...
import doctrine.Class.Checks.ChecksFactory;
...
public class ChecksPackageImpl extends EPackageImpl implements ChecksPackage {
	 ...
	 * @see doctrine.Class.Checks.ChecksPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getChecks_Checks() {
		return (EReference)checksEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(checksEClass, CHECKS__CHECKS);
	...
	public void initializePackageContents() {
		...
		checkEClass.getESuperTypes().add(theCommonPackage.getNamedElement());

		// Initialize classes and features; add operations and parameters
		initEClass(checksEClass, Checks.class, "Checks", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getChecks_Checks(), this.getCheck(), null, "checks", null, 0, -1, Checks.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(checkEClass, Check.class, "Check", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCheck_Condition(), ecorePackage.getEString(), "condition", null, 1, 1, Check.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
