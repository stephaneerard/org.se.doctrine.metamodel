 ...
 * <ul>
 *   <li>{@link doctrine.Class.Options.impl.OptionsImpl#getOptions <em>Options</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OptionsImpl extends EObjectImpl implements Options {
	...
	public EList<Option> getOptions() {
		if (options == null) {
			options = new EObjectContainmentEList<Option>(Option.class, this, OptionsPackage.OPTIONS__OPTIONS);
		}
		return options;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OptionsPackage.OPTIONS__OPTIONS:
