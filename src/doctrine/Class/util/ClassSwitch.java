...
public class ClassSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ClassPackage.CLASS: {
				doctrine.Class.Class class_ = (doctrine.Class.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = caseNamedElement(class_);
				if (result == null) result = caseConnectableElement(class_);
	 ...
	 * @generated
	 */
	public T caseClass(doctrine.Class.Class object) {
		return null;
	}
