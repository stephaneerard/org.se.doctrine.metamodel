 ...
 * <!-- end-user-doc -->
 * @see doctrine.Class.ClassPackage
 * @generated
 */
public class ClassAdapterFactory extends AdapterFactoryImpl {
	...
	protected ClassSwitch<Adapter> modelSwitch =
		new ClassSwitch<Adapter>() {
			@Override
			public Adapter caseClass(doctrine.Class.Class object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link doctrine.Class.Class <em>Class</em>}'.
	 * <!-- begin-user-doc -->
