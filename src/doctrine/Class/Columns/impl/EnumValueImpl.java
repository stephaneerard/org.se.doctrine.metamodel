 ...
 * <ul>
 *   <li>{@link doctrine.Class.Columns.impl.EnumValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumValueImpl extends EObjectImpl implements EnumValue {
	...
	protected EClass eStaticClass() {
		return ColumnsPackage.Literals.ENUM_VALUE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ColumnsPackage.ENUM_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ColumnsPackage.ENUM_VALUE__VALUE:
				return getValue();
		}
