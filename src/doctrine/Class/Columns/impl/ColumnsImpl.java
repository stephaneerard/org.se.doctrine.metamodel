 ...
 * <ul>
 *   <li>{@link doctrine.Class.Columns.impl.ColumnsImpl#getColumns <em>Columns</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ColumnsImpl extends EObjectImpl implements Columns {
	...
	protected EClass eStaticClass() {
		return ColumnsPackage.Literals.COLUMNS;
	}
	...
	public EList<Column> getColumns() {
		if (columns == null) {
			columns = new EObjectContainmentEList<Column>(Column.class, this, ColumnsPackage.COLUMNS__COLUMNS);
		}
		return columns;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ColumnsPackage.COLUMNS__COLUMNS:
