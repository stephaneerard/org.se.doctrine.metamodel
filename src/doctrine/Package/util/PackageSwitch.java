 ...
 * <!-- end-user-doc -->
 * @see doctrine.Package.PackagePackage
 * @generated
 */
public class PackageSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PackagePackage.PACKAGE: {
				doctrine.Package.Package package_ = (doctrine.Package.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = caseConnectableElement(package_);
				if (result == null) result = caseNamedElement(package_);
				if (result == null) result = caseAbstractContainer(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PackagePackage.ABSTRACT_CONTAINER: {
	 ...
	 * @generated
	 */
	public T casePackage(doctrine.Package.Package object) {
		return null;
	}
